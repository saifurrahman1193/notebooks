...
| -------------------- | ----------------------------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------- | ------------------------------------------ | ---------------------------------- |
| **Time Complexity**  | $O(b^m)$ — explores deep first, where $b$ = branching factor, $m$ = max depth | $O(b^s)$ — explores shallow first, $s$ = depth of solution | $O(b^l)$ — limited by depth limit $l$ | $O(b^s)$ — repeats DFS up to depth $d$     | Exponential                        |
